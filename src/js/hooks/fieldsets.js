						...
						return superagent
							...
							.then(() => {
								return superagent
									...
									.query({
										url:
											productPerformanceURL +
											defaultDateRange
									})
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.product_performance = {
											Rent: [],
											Buy: [object],
											table: results,
											type: "All",
									...
									.catch(err => {
										console.log(
											"fails at product performance"
										);
										//@todo: implement error handling
										//reject('failed');
										agencyProfileData.failed = true;
									});
							})
							.then(() => {
								return superagent
									...
									.query({
										url:
										rankAgainstCompetitorsURL +
											defaultDateRange
									})
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.rank_against_competitors = {
											Rent: [],
											Buy: [object],
											table: results,
											type: "All",
									...
									.catch(err => {
										//@todo: implement error handling
										console.log(
											"fails at rank against competitors"
										);
										agencyProfileData.failed = true;
									});
							})
							.then(() => {
								return superagent
									...
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.market_comparison = {
											Rent: [],
											Buy: [object],
											table: results,
											type: "All",
							...
							.then(() => {
								return superagent
									...
									.query({
										url:
											marketRentComparisonURL +
											defaultDateRange
									})
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.market_comparison_rent = {
											Rent: [object],
											Buy: [],
											table: results,
											type: "All",
							...
							.then(() => {
								return superagent
									...
									.query({
										url:
											performanceOverTimeURL +
											defaultDateRange
									})
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.product_performance_time = {
											Rent: [],
											Buy: [object],
											table: results,
											type: "All",
									...
									.catch(err => {
										console.log(
											"fails at market performance over time"
										);
										agencyProfileData.failed = true;
									});
							})
							.then(() => {
								return superagent
									...
									.then(({ body: results }) => {
										let object = {};
										object[dateKey] = { all: results };
										agencyProfileData.you_vs_market_rank = {
											New: [],
											Sold: [object],
											table: results,
											type: "All",
									...
									.catch(err => {
										console.log(
											"fails at you vs market ranking"
										);
										agencyProfileData.failed = true;
									});
							})
