function rankAgainstCompetitorsLuxeRenderCallback($pageContainer) {
	...
	this.renderPieChart = function({
		...
		var pieChartColors = [am4core.color("#3E3B41"), am4core.color("#66408D"), am4core.color("#8154AB"), am4core.color("#BB94D4"), am4core.color("#716E75"), am4core.color("#BEBAC2")]
